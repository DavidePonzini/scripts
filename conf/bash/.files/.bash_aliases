...
alias la='ls -AvhF'
alias ll='eza -alhF --group-directories-first --git --git-repos'
alias ln='ln -v'
...
alias pythons='/scripts/venv/bin/python'
alias pythonv='./venv/bin/python'
alias ipythonv='./venv/bin/ipython'
alias ipythons='/scripts/venv/bin/ipython'
